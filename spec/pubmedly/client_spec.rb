  ...
  RSpec.describe Client do
    ...
    describe "#search" do
      ...
      describe "term" do
        ...
        it "takes a single term" do
          VCR.use_cassette("client/search/covid") do
        ...
        it "takes multiple terms" do
          VCR.use_cassette("client/search/covid neuropathy") do
        ...
        it "takes a phrase" do
          VCR.use_cassette("client/search/varicella zoster") do
        ...
        describe "field tags" do
          ...
          it "use [pdat] for Publication Date" do
            ...
            VCR.use_cassette("client/search/long covid pdat") do
          ...
          it "use [crdt] for Pubmed Creation Date (more comprehensive than Publication Date)" do
            ...
            VCR.use_cassette("client/search/long covid crdt") do
          ...
          it "use [ad] for Affiliation" do
            VCR.use_cassette("client/search/University of Glasgow [ad]") do
          ...
          describe "title and abstract fields" do
            it "use [ti] for Title" do
              VCR.use_cassette("client/search/long covid [ti]") do
            ...
            it "use [tiab] for Title/Abstract" do
              VCR.use_cassette("client/search/long covid [tiab]") do
            ...
            it "allow proximity search by appending :~n" do
              VCR.use_cassette("client/search/covid treatment [tiab:~3]") do
      ...
      describe "optional parameters for retrieval" do
        ...
        it "rettype of :count" do
          VCR.use_cassette("client/search/MCAS [ti] rettype: :count") do
        ...
        it "retstart" do
          VCR.use_cassette("client/search/long covid retstart: 1000") do
        ...
        it "retmax" do
          VCR.use_cassette("client/search/long covid retmax: 1000") do
        ...
        it "retmode of :json" do
          VCR.use_cassette("client/search/prusty[au] retmode: :json") do
        ...
        it "field" do
          VCR.use_cassette("client/search/covid field: title") do
        ...
        it "sort" do
          VCR.use_cassette("client/search/long covid sort: pub_date") do
      ...
      describe "optional parameters for dates" do
        it "takes a reldate" do
          VCR.use_cassette("client/search/long covid reldate: 1") do
        ...
        it "takes a min/max date" do
          VCR.use_cassette("client/search/long covid mindate: 2022-12-25 maxdate: 2022-12-31") do
        ...
        it "takes a datetype" do
          ...
          VCR.use_cassette("client/search/long covid datetype: mdat, reldate: 1") do
    ...
    describe "fetch" do
      it "takes a single id" do
        VCR.use_cassette("client/fetch/36410718") do
      ...
      it "takes an array of ids" do
        VCR.use_cassette("client/fetch/36410718 36460909") do
      ...
      describe "optional parameters for retrieval" do
        describe "retmode" do
          it "can be text" do
            VCR.use_cassette("client/fetch/36410718 retmode text") do
          ...
          it "with explicit abstract rettype" do
            VCR.use_cassette("client/fetch/36410718 retmode text rettype abstract") do
        ...
        describe "rettype" do
          ...
          it "can be medline" do
            VCR.use_cassette("client/fetch/36410718 rettype medline") do
          ...
          it "can be uilist" do
            VCR.use_cassette("client/fetch/36410718 rettype uilist") do
